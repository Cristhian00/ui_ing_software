 ...
 * </p>
 * <ul>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getPositionX <em>Position X</em>}</li>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getPositionY <em>Position Y</em>}</li>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getHeigth <em>Heigth</em>}</li>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getBackgroundColor <em>Background Color</em>}</li>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getTitleFont <em>Title Font</em>}</li>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getTitleFontSize <em>Title Font Size</em>}</li>
 *   <li>{@link ui_concreta.impl.UserInterfaceImpl#getLstModelElements <em>Lst Model Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserInterfaceImpl extends EObjectImpl implements UserInterface {
	...
	protected EClass eStaticClass() {
		return Ui_concretaPackage.Literals.USER_INTERFACE;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.USER_INTERFACE__TITLE, oldTitle, title));
	}
	...
	public void setPositionX(String newPositionX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.USER_INTERFACE__POSITION_X, oldPositionX, positionX));
	}
	...
	public void setPositionY(String newPositionY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.USER_INTERFACE__POSITION_Y, oldPositionY, positionY));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.USER_INTERFACE__WIDTH, oldWidth, width));
	}
	...
	public void setHeigth(String newHeigth) {
		...
		heigth = newHeigth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.USER_INTERFACE__HEIGTH, oldHeigth, heigth));
	}
	...
	public void setBackgroundColor(String newBackgroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.USER_INTERFACE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
	}
	...
	public void setTitleFont(String newTitleFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.USER_INTERFACE__TITLE_FONT, oldTitleFont, titleFont));
	}
	...
	public void setTitleFontSize(String newTitleFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.USER_INTERFACE__TITLE_FONT_SIZE, oldTitleFontSize, titleFontSize));
	}
	...
	public EList<ModelElement> getLstModelElements() {
		if (lstModelElements == null) {
			lstModelElements = new EObjectContainmentEList<ModelElement>(ModelElement.class, this, Ui_concretaPackage.USER_INTERFACE__LST_MODEL_ELEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ui_concretaPackage.USER_INTERFACE__LST_MODEL_ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ui_concretaPackage.USER_INTERFACE__TITLE:
				return getTitle();
			case Ui_concretaPackage.USER_INTERFACE__POSITION_X:
				return getPositionX();
			case Ui_concretaPackage.USER_INTERFACE__POSITION_Y:
				return getPositionY();
			case Ui_concretaPackage.USER_INTERFACE__WIDTH:
				return getWidth();
			case Ui_concretaPackage.USER_INTERFACE__HEIGTH:
				return getHeigth();
			case Ui_concretaPackage.USER_INTERFACE__BACKGROUND_COLOR:
				return getBackgroundColor();
			case Ui_concretaPackage.USER_INTERFACE__TITLE_FONT:
				return getTitleFont();
			case Ui_concretaPackage.USER_INTERFACE__TITLE_FONT_SIZE:
