 ...
 * </p>
 * <ul>
 *   <li>{@link ui_concreta.impl.ModelElementImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link ui_concreta.impl.ModelElementImpl#getPositionX <em>Position X</em>}</li>
 *   <li>{@link ui_concreta.impl.ModelElementImpl#getPositionY <em>Position Y</em>}</li>
 *   <li>{@link ui_concreta.impl.ModelElementImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link ui_concreta.impl.ModelElementImpl#getHeigth <em>Heigth</em>}</li>
 *   <li>{@link ui_concreta.impl.ModelElementImpl#getBackgroundColor <em>Background Color</em>}</li>
 *   <li>{@link ui_concreta.impl.ModelElementImpl#getTitleFont <em>Title Font</em>}</li>
 *   <li>{@link ui_concreta.impl.ModelElementImpl#getTitleFontSize <em>Title Font Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ModelElementImpl extends EObjectImpl implements ModelElement {
	...
	protected EClass eStaticClass() {
		return Ui_concretaPackage.Literals.MODEL_ELEMENT;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.MODEL_ELEMENT__TITLE, oldTitle, title));
	}
	...
	public void setPositionX(String newPositionX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.MODEL_ELEMENT__POSITION_X, oldPositionX, positionX));
	}
	...
	public void setPositionY(String newPositionY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.MODEL_ELEMENT__POSITION_Y, oldPositionY, positionY));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.MODEL_ELEMENT__WIDTH, oldWidth, width));
	}
	...
	public void setHeigth(String newHeigth) {
		...
		heigth = newHeigth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.MODEL_ELEMENT__HEIGTH, oldHeigth, heigth));
	}
	...
	public void setBackgroundColor(String newBackgroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.MODEL_ELEMENT__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
	}
	...
	public void setTitleFont(String newTitleFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.MODEL_ELEMENT__TITLE_FONT, oldTitleFont, titleFont));
	}
	...
	public void setTitleFontSize(String newTitleFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretaPackage.MODEL_ELEMENT__TITLE_FONT_SIZE, oldTitleFontSize, titleFontSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ui_concretaPackage.MODEL_ELEMENT__TITLE:
				return getTitle();
			case Ui_concretaPackage.MODEL_ELEMENT__POSITION_X:
				return getPositionX();
			case Ui_concretaPackage.MODEL_ELEMENT__POSITION_Y:
				return getPositionY();
			case Ui_concretaPackage.MODEL_ELEMENT__WIDTH:
				return getWidth();
			case Ui_concretaPackage.MODEL_ELEMENT__HEIGTH:
				return getHeigth();
			case Ui_concretaPackage.MODEL_ELEMENT__BACKGROUND_COLOR:
				return getBackgroundColor();
			case Ui_concretaPackage.MODEL_ELEMENT__TITLE_FONT:
				return getTitleFont();
			case Ui_concretaPackage.MODEL_ELEMENT__TITLE_FONT_SIZE:
