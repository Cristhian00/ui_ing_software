...
/**
 * This is the item provider adapter for a {@link ui_concreta.UserInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserInterfaceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretaPackage.Literals.USER_INTERFACE__TITLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretaPackage.Literals.USER_INTERFACE__POSITION_X,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretaPackage.Literals.USER_INTERFACE__POSITION_Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretaPackage.Literals.USER_INTERFACE__WIDTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretaPackage.Literals.USER_INTERFACE__HEIGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretaPackage.Literals.USER_INTERFACE__BACKGROUND_COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretaPackage.Literals.USER_INTERFACE__TITLE_FONT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretaPackage.Literals.USER_INTERFACE__TITLE_FONT_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createContainer()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createIFrame()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createLabel()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createInput()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createButton()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createSelect()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createTable()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createImg()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createBlockquote()));

		newChildDescriptors.add
			(createChildParameter
				(Ui_concretaPackage.Literals.USER_INTERFACE__LST_MODEL_ELEMENTS,
				 Ui_concretaFactory.eINSTANCE.createUl()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return Ui_concretaEditPlugin.INSTANCE;
	}
