 ...
 * @generated
 */
public class Ui_concretaValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = ui_concreta.diagram.part.Ui_concretaDiagramEditorPlugin.ID
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ui_concreta.diagram.part.Ui_concretaDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && ui_concreta.diagram.edit.parts.UI_DiagramEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				ui_concreta.diagram.part.Ui_concretaDiagramEditorPlugin.getInstance().logError("ViewID access failure", //$NON-NLS-1$
						e);
			}
		}
