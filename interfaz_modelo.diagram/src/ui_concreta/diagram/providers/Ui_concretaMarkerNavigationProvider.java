 ...
 * @generated
 */
public class Ui_concretaMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = ui_concreta.diagram.part.Ui_concretaDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ui_concreta.diagram.part.Ui_concretaDiagramEditorUtil.selectElementsInDiagram(editor,
