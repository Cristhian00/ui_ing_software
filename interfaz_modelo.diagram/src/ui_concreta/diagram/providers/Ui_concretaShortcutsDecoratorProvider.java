 ...
 * @generated
 */
public class Ui_concretaShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = ui_concreta.diagram.part.Ui_concretaDiagramEditorPlugin.getInstance()
