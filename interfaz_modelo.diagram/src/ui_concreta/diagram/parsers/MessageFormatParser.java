 ...
 * 
 */
package ui_concreta.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ui_concreta.diagram.part.Ui_concretaDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ui_concreta.diagram.part.Messages.MessageFormatParser_InvalidInputError,
