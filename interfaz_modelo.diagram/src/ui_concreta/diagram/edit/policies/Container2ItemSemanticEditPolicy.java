 ...
 * @generated
 */
public class Container2ItemSemanticEditPolicy
	...
	*/
	public Container2ItemSemanticEditPolicy() {
		super(ui_concreta.diagram.providers.Ui_concretaElementTypes.Container_3002);
	}
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (ui_concreta.diagram.part.Ui_concretaVisualIDRegistry.getVisualID(node)) {
			case ui_concreta.diagram.edit.parts.ContainerContainerLstChildModelElementsCompartment2EditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (ui_concreta.diagram.part.Ui_concretaVisualIDRegistry.getVisualID(cnode)) {
