...
public class UI_DiagramEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Ui_concreta"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_concreta.diagram.edit.policies.UI_DiagramItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ui_concreta.diagram.edit.policies.UI_DiagramCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new ui_concreta.diagram.edit.commands.Ui_concretaCreateShortcutDecorationsCommand(
