...
public class SelectEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_concreta.diagram.edit.policies.SelectItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_concreta.diagram.edit.parts.SelectTitleEditPart) {
			((ui_concreta.diagram.edit.parts.SelectTitleEditPart) childEditPart)
