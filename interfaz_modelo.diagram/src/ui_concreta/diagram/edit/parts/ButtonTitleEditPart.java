	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_concreta.diagram.providers.Ui_concretaParserProvider.getParser(
					ui_concreta.diagram.providers.Ui_concretaElementTypes.Button_3006, getParserElement(),
					ui_concreta.diagram.part.Ui_concretaVisualIDRegistry
							.getType(ui_concreta.diagram.edit.parts.ButtonTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
