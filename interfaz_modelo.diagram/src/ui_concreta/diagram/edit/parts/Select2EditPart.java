...
public class Select2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_concreta.diagram.edit.policies.Select2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_concreta.diagram.edit.parts.SelectTitle2EditPart) {
			((ui_concreta.diagram.edit.parts.SelectTitle2EditPart) childEditPart)
