...
public class UserInterfaceTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ui_concreta.diagram.edit.policies.Ui_concretaTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ui_concreta.diagram.providers.Ui_concretaElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ui_concreta.diagram.providers.Ui_concretaParserProvider.getParser(
					ui_concreta.diagram.providers.Ui_concretaElementTypes.UserInterface_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ui_concreta.diagram.edit.parts.Ui_concretaEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
