 ...
 * @generated
 */
public class Ui_concretaDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public Ui_concretaDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ui_concreta.diagram.navigator.Ui_concretaDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((ui_concreta.diagram.navigator.Ui_concretaDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ui_concreta.diagram.navigator.Ui_concretaDomainNavigatorItem((EObject) objects[i],
